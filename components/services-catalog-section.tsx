...
import { serviceCardImage, services } from '@/lib/services'
        ...
        {showIntro && (
          <header className="mb-12 max-w-2xl lg:mb-16">
            ...
            <p className="body-lead mt-4 max-w-xl">
              Air conditioning, heating, mini splits, QuietCool, repairs, and new installs for San
              Diego County homes. Pick a service below to get a free estimate or see the details.
            </p>
          </header>
        )}
